package com.example.peerconnect.adapters
...
import com.example.peerconnect.databinding.ItemMainRecyclerViewBinding
...
class MainRecyclerViewAdapter(private val listener: Listener): RecyclerView.Adapter<MainRecyclerViewAdapter.MainRecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MainRecyclerViewHolder, position: Int) {
        usersList?.let { list ->
            ...
            holder.bind(
                user,
                {//video call clicked
                    listener.videoCallClicked(user.first)
                },
                {//audio call clicked
                    listener.audioCallClicked(user.first)
                }
            )
    ...
    interface Listener{
        fun videoCallClicked(username: String)
        fun audioCallClicked(username: String)
    }

    inner class MainRecyclerViewHolder(private val binding: ItemMainRecyclerViewBinding):
